...
exports.GetPayPerHour = exports.DisplayWorkingHoursModal = exports.UpdateLeaveWorkTime = exports.UpdateLeaveWorkTimeAndUpdate = exports.renderOvernightPay = exports.UpdateOvernightPayHour = exports.UpdateRemainWorkingHour = exports.UpdateRemainWorkingHourAndUpdate = exports.updateWorkingOverpayPlan = exports.updateWorkingPlan = exports.GetWorkingHours = exports.GetWorkingDay = exports.render_calculated_working_hour = exports.render_working_hour = void 0;
const CalendarViewAPI = require("./CalendarViewHandler.js");
const DataStorageAPI = require("../Datas/DataStorageHandler.js");
const CalendarAPI = require("./CalendarAPI.js");
const MainPageHandlerAPI = require("../Layout/MainPageHandler.js");
const $ = require("jquery");
let overtime_work = 0;
let working_hour_plan = 0;
let working_overpay_plan = 0;
let today_remain_time_minute = 0;
let payPerHour = 0;
...
exports.render_working_hour = render_working_hour;
...
exports.render_calculated_working_hour = render_calculated_working_hour;
...
function GetRemainedWorkingHour(maxWorkingHour, currentDay, isCurrentWorkingDay, remainWorkingDayCnt) {
...
exports.updateWorkingPlan = updateWorkingPlan;
...
exports.updateWorkingOverpayPlan = updateWorkingOverpayPlan;
...
exports.UpdateRemainWorkingHourAndUpdate = UpdateRemainWorkingHourAndUpdate;
...
exports.UpdateRemainWorkingHour = UpdateRemainWorkingHour;
...
exports.UpdateOvernightPayHour = UpdateOvernightPayHour;
...
exports.renderOvernightPay = renderOvernightPay;
function UpdateLeaveWorkTimeAndUpdate() {
    UpdateLeaveWorkTime();
    CalendarViewAPI.UpdateAllViews();
}
exports.UpdateLeaveWorkTimeAndUpdate = UpdateLeaveWorkTimeAndUpdate;
function UpdateLeaveWorkTime() {
    let leaveWorkTimeElement = document.getElementById("leave_work_time");
...
exports.UpdateLeaveWorkTime = UpdateLeaveWorkTime;
function DisplayWorkingHoursModal() {
    $('.working_hour_modal').modal('show');
}
exports.DisplayWorkingHoursModal = DisplayWorkingHoursModal;
function GetPayPerHour() {
    return payPerHour;
}
exports.GetPayPerHour = GetPayPerHour;
